...
export default function EditServicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchServiceData = async () => {
      try {
        const service = await vendorService.getServiceById(id);
        ...
        setFormData({
          ...
          subcategoryId: service.servicetype.subcategoryId,
          categoryId: service.servicetype.subcategory.categoryId,
          eventTypeId: service.servicetype.subcategory.category.eventTypeId,
  ...
  const handleSubmit = async () => {
    try {
      setLoading(true);
      await vendorService.updateService(id, {
        ...formData,
  ...
  if (fetching) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center gap-4">
        ...
        <p className="font-black uppercase tracking-widest text-muted-foreground animate-pulse">Loading Service Details...</p>
      </div>
    );
  }
            ...
            {step === 1 && (
              ...
              >
                <div>
                  ...
                  <p className="text-muted-foreground font-medium">Update the essentials of your service.</p>
                </div>
            ...
            {step === 3 && (
              ...
              >
                <div>
                  ...
                  <p className="text-muted-foreground font-medium">Add photos and save your changes.</p>
                </div>
